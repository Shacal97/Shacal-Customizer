...
4. Przeciągnij **zawartość** rozpakowanego folderu, razem z katalogami `addons` i `assets`. Nie wgrywaj samego ZIP-a ani nadrzędnego folderu `Shacal_Repo_v6.3.6`.
...
Po wgraniu całej zawartości tej wersji i zakończeniu publikacji Pages zaktualizuj instalator z tego samego adresu install.user.js do v6.3.6. Nie trzeba zmieniać adresów.
